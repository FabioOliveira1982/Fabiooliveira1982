...
Tenho evoluído constantemente em lógica de programação, desenvolvimento web e boas práticas de código, construindo projetos práticos para consolidar meu aprendizado.
...
📌 Em constante construção de novos projetos para fortalecer meu portfólio.  
Você pode acompanhar minha evolução nos repositórios abaixo.

---

## 🎯 Objetivo Profissional

Conquistar uma oportunidade de estágio ou posição júnior em Tecnologia da Informação, aplicando meus conhecimentos técnicos e evoluindo junto com a equipe e a empresa.
